...
if TYPE_CHECKING:
    from .media_artifact_observation_interpreter import (
        MediaArtifactObservationInterpreter,
    )


@dataclass(frozen=True, slots=True)
class MediaArtifactInterpreterSummary:
    """Lightweight diagnostics for the media artifact observation interpreter."""
    ...
    def from_interpreter(
        cls,
        interpreter: MediaArtifactObservationInterpreter,
