...
| [Demo 2 database compatibility upgrade and write-bearing rehearsal](demo2-database-upgrade-and-write-rehearsal.md) | In progress - bounded migration plus explicitly authorized guarded test write | StageFlow Demo Operations / Backend / Integration | ED-0071 unqualified result; accepted migration 0010; ED-0072 |
