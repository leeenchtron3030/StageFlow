...
| [Demo 2 database compatibility upgrade and write-bearing rehearsal](demo2-database-upgrade-and-write-rehearsal.md) | Completed - core/write flow qualified; PR promotion unqualified | StageFlow Demo Operations / Backend / Integration | ED-0071 unqualified result; accepted migration 0010; ED-0072 |
