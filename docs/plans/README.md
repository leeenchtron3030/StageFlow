...
| [Post-Kernel capability layer](post-kernel-capability-layer.md) | Proposed — explicit decisions required; no implementation started | StageFlow Architecture / Product / Backend | ADR-0022-ADR-0024; proposed ADR-0025-ADR-0026 |
