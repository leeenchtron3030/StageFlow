...
| [ADR-0032](ADR-0032-render-durable-operation.md) | Render Durable Operation by additive generalization of the ADR-0025 substrate; immutable Rendered Output identity; video-only first render profile; configured render output root | Accepted | Accepted by the owner 2026-09-25; implementation planned as ED-0087 |
