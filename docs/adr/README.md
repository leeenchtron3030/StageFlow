...
| [ADR-0030](ADR-0030-packaging-asset-identity.md) | Separate `PackagingAsset` aggregate owned by Assembly, distinct from Completed Media Asset | Accepted | ED-0076 implements Packaging Asset identity, immutable content revisions, and human approval lineage; Session Assembly remains ED-0077 scope |
