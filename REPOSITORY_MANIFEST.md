...
| `backend/app/contexts/production/` | Production context package. | ED-0002 / ED-0005 / ED-0012 through ED-0040 / ED-0042 through ED-0046 | Contains backend-only Production contracts and behavior through acceptance, authoritative context, and the infrastructure-neutral Operational State Repository boundary; ED-0046 adds no concrete storage or execution behavior. |
...
| `backend/app/contexts/production/operational_state_repository/` | Operational State Repository contract package. | ED-0046 | Backend-only infrastructure-neutral interface and immutable record, query, history, commit, reason, outcome, and error contracts for atomically storing accepted Recording and Session state without any concrete store, policy or acceptance invocation, execution, APIs, queues, workers, retries, AI, or frontend behavior. |
...
| `backend/tests/` | Backend test suite. | ED-0002 through ED-0046 / reviewed by ED-0041 | Contains 852 health, shared, Production Event, interpreter, Observation, Evidence, context resolution, builder, Operational State, transition policy, propagation, acceptance, and repository-contract tests. |
...
| `ENGINEERING_DIRECTIVES.md` | Engineering Directive index. | ED-0001 / ED-0046 | Registers approved and implemented directives through ED-0046. |
...
| `REPOSITORY_MANIFEST.md` | Repository structure and ownership manifest. | ED-0001 / ED-0046 | Created by ED-0001 and updated through the ED-0046 Operational State Repository contract boundary. |
...
| `backend/app/contexts/production/operational_state/README.md` | Operational State package guide. | ED-0033 / ED-0044 / ED-0046 | Documents mission boundary, state families, acceptance-grade traceability, immutable successor creation, separate persisted status, and repository/execution boundaries. |
...
| `backend/app/contexts/production/operational_state_acceptance/README.md` | Operational State Acceptance package guide. | ED-0044 / ED-0046 | Documents eligibility, lineage, current-state, subject, context, lifecycle, successor, descriptive supersession, repository handoff, idempotency separation, timestamp, immutability, and architecture boundaries. |
...
| `backend/app/contexts/production/operational_state_repository/__init__.py` | Operational State Repository package exports. | ED-0046 | Exports the abstract interface and immutable record, query, history, commit, outcome, reason, and error contracts. |
| `backend/app/contexts/production/operational_state_repository/README.md` | Operational State Repository package guide. | ED-0046 | Documents atomic accepted-state commit, current uniqueness, idempotency, concurrency, supersession, lineage, history, timestamp, infrastructure, and mission boundaries. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0046 | Documents implemented backend coverage through ED-0046, including repository contract, atomic-result, concurrency, history, lineage, timestamp, and architecture boundaries. |
