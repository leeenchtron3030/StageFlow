...
| `backend/tests/` | Backend test suite. | ED-0002 through ED-0045 / reviewed by ED-0041 | Contains 826 health, shared, Production Event, interpreter, Observation, Evidence, context resolution, builder, Operational State, transition policy, propagation, and Operational State Acceptance tests. |
...
| `ENGINEERING_DIRECTIVES.md` | Engineering Directive index. | ED-0001 / ED-0045 | Registers approved and implemented directives through ED-0045. |
...
| `REPOSITORY_MANIFEST.md` | Repository structure and ownership manifest. | ED-0001 / ED-0045 | Created by ED-0001 and updated through the ED-0045 AR-3.0 context-authority boundary. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0045 | Documents implemented backend coverage through ED-0045, including authoritative context resolution and propagation. |
