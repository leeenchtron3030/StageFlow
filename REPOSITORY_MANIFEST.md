...
| `backend/tests/` | Backend test suite. | ED-0002 through ED-0042 / reviewed by ED-0041 | Contains 712 health, shared, Production Event, interpreter, Observation, Evidence, builder, Operational State, and transition policy tests. |
...
| `backend/app/contexts/production/recording_transition_policy/__init__.py` | Recording Transition Policy package exports. | ED-0034 / ED-0035 / ED-0042 | Exports the policy, context, Evidence profile, result, rule, signal mapping, summary, and helpers. |
...
| `backend/app/contexts/production/recording_transition_policy/recording_transition_policy.py` | Recording Transition Policy implementation. | ED-0034 / ED-0035 / ED-0042 | Deterministically isolates compatible recording Evidence before validating lifecycle proposals and returning descriptive evaluations. |
...
| `backend/app/contexts/production/transition_policy/README.md` | Transition Policy package guide. | ED-0034 / ED-0042 | Documents policy evaluation, outcomes, deferred execution, and the recording-local context-safety correction. |
