...
| `backend/app/contexts/production/` | Production context package. | ED-0002 / ED-0005 / ED-0012 through ED-0040 / ED-0042 through ED-0051 | Contains backend-only Production contracts and behavior through acceptance, authoritative context, repository proof, completed-media/readiness contracts, the declarative Runtime, and one explicit Agent lifecycle; no production persistence, ingest, media execution, or operating-system service behavior. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0047 through ED-0051 | Documents implemented backend coverage through ED-0051, including the declarative Runtime and explicit Agent lifecycle, pressure, synchronization, atomicity, safety, and architecture boundaries. |
