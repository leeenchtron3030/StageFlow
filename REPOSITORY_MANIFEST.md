...
| `backend/app/contexts/production/` | Production context package. | ED-0002 / ED-0005 / ED-0012 through ED-0040 / ED-0042 through ED-0049 | Contains backend-only Production contracts and behavior through acceptance, authoritative context, the Operational State Repository proof, completed-media contracts, and supplied-fact readiness evaluation; no production persistence, Runtime service, ingest, or execution behavior. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0047 / ED-0048 / ED-0049 | Documents implemented backend coverage through ED-0049, including completed-media and asset-readiness contracts, invariants, policy routes, conflicts, deployment neutrality, determinism, privacy, and architecture boundaries. |
