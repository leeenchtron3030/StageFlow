...
| `backend/app/contexts/production/recording_activity_observation_interpreter/README.md` | Recording activity observation interpreter package guide. | ED-0024 | Documents the reference concrete interpreter, objective mappings, exclusions, and current timeline-location limitation. |
