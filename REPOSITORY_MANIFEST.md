...
| `backend/app/contexts/production/evidence_builder/` | Observation evidence builder package. | ED-0031 | Backend-only reasoning boundary that organizes objective Observations into explainable Evidence; no semantic interpretation, Hypotheses, Findings, Verification Decisions, Operational Products, Operational State, AI, persistence, APIs, queues, workers, provider-specific behavior, or frontend behavior. |
...
| `backend/app/contexts/production/evidence/evidence_set.py` | Evidence set contract. | ED-0007 / ED-0031 | Groups one or more evidence items; ED-0031 allows non-recording-block Evidence when source Observations are truthfully anchored elsewhere. |
...
| `backend/app/contexts/production/evidence_builder/__init__.py` | Observation evidence builder package exports. | ED-0031 | Exports the builder, context, rule, result, summary, status, and default rule helpers. |
| `backend/app/contexts/production/evidence_builder/README.md` | Observation evidence builder package guide. | ED-0031 | Documents the Observation-to-Evidence boundary, operational concerns, traceability, and excluded reasoning behavior. |
...
| `backend/app/contexts/production/evidence_builder/evidence_builder_rule.py` | Evidence builder rule contract. | ED-0031 | Declarative single-operational-concern grouping rule for supporting, contradicting, and contextual Observation types. |
| `backend/app/contexts/production/evidence_builder/evidence_builder_summary.py` | Evidence builder summary contract. | ED-0031 | Lightweight diagnostics for rule and operational concern counts. |
| `backend/app/contexts/production/evidence_builder/observation_evidence_builder.py` | Observation evidence builder contract. | ED-0031 | Groups objective Observations into existing EvidenceSet contracts while preserving traceability and avoiding semantic conclusions. |
...
| `backend/tests/test_observation_evidence_builder_contracts.py` | Observation evidence builder contract tests. | ED-0031 | Covers builder creation, zero-observation input, single and multiple grouping, independent Evidence sets, supporting/contradicting/contextual references, traceability preservation, explainability, and excluded later reasoning behavior. |
