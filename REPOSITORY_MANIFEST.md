...
| `backend/app/contexts/production/` | Production context package. | ED-0002 / ED-0005 / ED-0012 through ED-0040 / ED-0042 through ED-0052 | Contains backend-only Production contracts and behavior through acceptance, repository proof, completed-media/readiness contracts, declarative Runtime, Agent lifecycle, and bounded injected media collection; no production persistence, ingest, concrete media adapter, or operating-system service behavior. |
...
| `backend/app/contexts/production/asset_readiness/media_asset_candidate.py` | Media asset candidate contract. | ED-0049 | Retains proposed identity, Runtime provenance, explicit context, intended kind, relationship, and first-observed time without completion, readiness, workflow, or Session claims. |
...
| `backend/app/contexts/production/media_collection/media_collection_contracts.py` | Media collection contracts. | ED-0052 | Defines immutable discovery/observation/cycle inputs and results, candidate records, conflicts, snapshots, summaries, and typed query results. |
...
| `backend/tests/` | Backend test suite. | ED-0002 through ED-0049 / reviewed by ED-0041 | Contains health, shared, Production Event, interpreter, Observation, Evidence, context resolution, builder, Operational State, transition policy, propagation, acceptance, repository, completed-media, and asset-readiness tests. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0047 through ED-0052 | Documents implemented backend coverage through ED-0052, including Runtime, Agent lifecycle, and bounded media collection permission, identity, accumulation, synchronization, atomicity, safety, and architecture boundaries. |
...
| `backend/tests/test_asset_readiness_deployment_neutrality.py` | Asset readiness deployment-neutrality tests. | ED-0049 | Covers Agent, Node, external, and unknown profile parity; profile-independent parameters and results; naming independence; and optional capability routes. |
