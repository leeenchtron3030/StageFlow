...
| `backend/app/contexts/production/` | Production context package. | ED-0002 / ED-0005 / ED-0012 through ED-0040 / ED-0042 through ED-0050 | Contains backend-only Production contracts and behavior through acceptance, authoritative context, repository proof, completed-media/readiness contracts, and the declarative Runtime; no production persistence, Runtime service, ingest, or execution behavior. |
...
| `backend/tests/README.md` | Backend test suite guide. | ED-0002 / ED-0041 / ED-0047 through ED-0050 | Documents implemented backend coverage through ED-0050, including Runtime contracts, capability combinations, resource/event constraints, readiness selection, health/availability, deployment neutrality, determinism, privacy, and architecture boundaries. |
