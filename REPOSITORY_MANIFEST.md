...
| `backend/app/contexts/production/operational_state_acceptance/` | Operational State Acceptance package. | ED-0044 | Backend-only validation boundary that may create one immutable Recording or Session successor from one eligible evaluation while describing supersession without policy invocation, mutation, repositories, persistence, execution, APIs, queues, workers, AI, or frontend behavior. |
...
| `backend/app/contexts/production/recording_transition_policy/` | Recording Transition Policy package. | ED-0034 / ED-0035 / ED-0042 | Backend-only context-safe policy for evaluating one compatible recording Evidence context into a descriptive recording-state proposal; no state acceptance, mutation, execution, repositories, persistence, APIs, queues, workers, AI, or frontend behavior. |
...
| `backend/app/contexts/production/transition_policy/` | Operational State Transition Policy package. | ED-0034 / ED-0042 | Backend-only generic transition-policy contracts and evaluations; ED-0042 documents the recording-local context safety correction without changing generic contracts, state mutation, execution, repositories, persistence, APIs, queues, workers, AI, or frontend behavior. |
...
| `backend/tests/` | Backend test suite. | ED-0002 through ED-0044 / reviewed by ED-0041 | Contains 783 health, shared, Production Event, interpreter, Observation, Evidence, builder, Operational State, transition policy, and Operational State Acceptance tests. |
...
| `backend/app/contexts/production/session_transition_policy/session_transition_policy.py` | Session Transition Policy implementation. | ED-0040 / ED-0044 | Deterministically evaluates compatible boundary Evidence into one TransitionEvaluation with traceability and explicit policy-kind handoff metadata, without execution, state mutation, scoring, or persistence. |
...
| `backend/app/contexts/production/operational_state/README.md` | Operational State package guide. | ED-0033 / ED-0044 | Documents mission boundary, state families, acceptance-grade traceability, environmental context, immutable successor creation, and deferred persistence and execution. |
...
| `backend/app/contexts/production/operational_state/operational_state_basis.py` | Operational State basis contract. | ED-0033 / ED-0044 | Backward-compatible ID-only Observation, EvidenceSet, accepted Transition Evaluation, policy, and rule traceability for why a state exists. |
...
| `backend/app/contexts/production/operational_state_acceptance/README.md` | Operational State Acceptance package guide. | ED-0044 | Documents eligibility, lineage, current-state, subject, context, lifecycle, successor, supersession, timestamp, history, immutability, and architecture boundaries. |
| `backend/app/contexts/production/operational_state_acceptance/operational_state_acceptance.py` | Operational State Acceptance implementation. | ED-0044 | Deterministically validates one evaluation and may construct one immutable successor plus a descriptive supersession without side effects. |
| `backend/app/contexts/production/operational_state_acceptance/operational_state_acceptance_context.py` | Acceptance-local operational context contract. | ED-0044 | Immutable partial ID-only stage, recording-block, schedule, stream, artifact, correlation, boundary-context, anchor, and timeline context. |
...
| `backend/app/contexts/production/recording_transition_policy/recording_transition_policy.py` | Recording Transition Policy implementation. | ED-0034 / ED-0035 / ED-0042 / ED-0044 | Deterministically isolates compatible recording Evidence, uses stable rule IDs, and preserves policy-kind and ED-0043 Event/interpreter lineage for acceptance handoff. |
...
| `backend/app/contexts/production/observation/observation.py` | Observation contract. | ED-0006 / ED-0025 / ED-0043 | Timestamped objective statement with compatible legacy fields plus authoritative first-class provenance and operational context. |
...
| `docs/reviews/ED-0041_FINDINGS_REGISTER.md` | Evidence-backed ED-0041 findings register. | ED-0041 / ED-0044 | Records severity, category, evidence, impact, response, change risk, directive, and disposition for every finding; ED-0044 closes ED0041-F003. |
